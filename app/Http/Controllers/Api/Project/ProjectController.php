...
class ProjectController extends Controller
{
     ...
     * )
     */
    public function store(StoreProjectRequest $request, CreateProjectAction $createProject): JsonResponse
    {
        ...
        $project = $createProject->execute(
            CreateProjectDTO::fromRequest($request, $architectId, $imagePaths, $layoutPaths)
        );
     ...
     * )
     */
    public function update(UpdateProjectRequest $request, string $id, UpdateProjectAction $updateProject): JsonResponse
    {
        ...
        if ($isAdmin) {
            ...
            $project = $updateProject->execute(
                $project,
                UpdateProjectDTO::fromArray(['status' => $data['status']])
            );
        ...
        $project = $updateProject->execute(
            $project,
            UpdateProjectDTO::fromRequest($request, $imagePaths, $layoutPaths)->withoutStatus(),
            resetStatus: true,
        );
