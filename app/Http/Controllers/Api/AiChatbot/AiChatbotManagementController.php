...
class AiChatbotManagementController extends Controller
{
     ...
     * )
     */
    public function performance(GetAiChatbotPerformanceAction $getPerformance): JsonResponse
    {
    ...
    {
        $filter = AiLogFilterDTO::fromRequest($request);
