...
class FaqController extends Controller
{
    ...
    {
        $faq = $createFaq->execute(CreateFaqDTO::fromRequest($request));
     ...
     * )
     */
    public function update(UpdateFaqRequest $request, string $id, UpdateFaqAction $updateFaq): JsonResponse
    {
        $faq = Faq::findOrFail($id);
        $faq = $updateFaq->execute($faq, UpdateFaqDTO::fromRequest($request));
