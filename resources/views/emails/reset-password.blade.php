...
<head>
    ...
    <title>Reset Password - HaloSitek</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 32px;">
                                        <a href="{{ $resetUrl }}"
                                           target="_blank"
                                           style="display: inline-block; background-color: #E8820C; color: #ffffff; font-size: 14px; font-weight: 700; text-decoration: none; padding: 14px 40px; border-radius: 10px; letter-spacing: 0.5px; text-transform: uppercase; box-shadow: 0 4px 14px rgba(232,130,12,0.35);">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <p style="margin: 0; font-size: 13px; color: #94a3b8; line-height: 1.6;">
                                            ⏱ This link will expire in <strong style="color: #64748b;">60 minutes</strong>.
